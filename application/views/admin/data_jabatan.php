<div class="container-fluid">
    ...
    <a class="btn btn-sm btn-success mb-3" href="<?php echo base_url('admin/data_jabatan/tambah_data') ?>">
            ...
            <tr>
                ...
                <td>
                    <center>
                        ...
                        <a onclick="return confirm('Apakah anda yakin ingin menghapus data ?')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/data_jabatan/delete_data/'.$j->id_jabatan) ?>">
